...
# copy busybox to system
${BUSYBOX} cp /tmp/recbox /system/etc/mm_twrp_recovery/busybox
${BUSYBOX} chown 0.2000 /system/etc/mm_twrp_recovery/busybox
${BUSYBOX} chmod 755 /system/etc/mm_twrp_recovery/busybox

# copy twrp recovery
${BUSYBOX} cp /tmp/recovery.twrp.cpio.lzma /system/etc/mm_twrp_recovery/recovery.twrp.cpio.lzma
...
${BUSYBOX} cp /tmp/boot_twrp_recovery.sh /system/etc/mm_twrp_recovery/boot_twrp_recovery.sh
...
${BUSYBOX} cp /tmp/chargemon.sh /system/bin/chargemon
